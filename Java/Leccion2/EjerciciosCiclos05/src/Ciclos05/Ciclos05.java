/*
Ejercicio5: Realizar un juego para adivinar un numero, para ello generar un numero aleatorio entre o-100, y luego ir pidiendo numeros indicando "es mayor" o "es menor" segun sea mayor menor con respecto a N 
