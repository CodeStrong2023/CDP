...
# Escriba un programa que tenga 2 listas y que a continuacion cree las siguientes listas (en las que no debe haver repeticiones)
...
solo1 = list(conjunto1 - conjunto2)  # Solo muetra el conjunto1
